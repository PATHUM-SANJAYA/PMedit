  ...
  return (
    <Layout>
        ...
        <div className="container-custom px-4 md:px-0">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-3 py-1.5 md:px-4 md:py-2 rounded-full glass-morphism border-white/5 mb-4 md:mb-6"
            >
              <User size={12} className="text-brand-green md:w-3 md:h-3" />
              <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-[0.3em] text-white/50">Behind the pixels</span>
            </motion.div>
            <motion.h1
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white tracking-tighter leading-[0.9] md:leading-[0.8] mb-4 md:mb-8"
            >
      ...
      <section className="py-8 md:py-10 relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[15vw] md:text-[18vw] font-black text-white/[0.02] pointer-events-none select-none z-0 tracking-tighter uppercase">
          Vision
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            >
              ...
              <div className="relative max-w-sm mx-auto group">
                ...
                {/* stylized circular frame with white margin */}
                <div className="relative aspect-square rounded-full border-[3px] border-white/90 p-2 shadow-[0_0_50px_rgba(255,255,255,0.1)] group-hover:border-white transition-all duration-700">
                ...
                <div className="absolute -bottom-4 -right-4 glass-morphism p-4 md:p-6 rounded-[1.5rem] border-brand-green/20 hidden md:block group-hover:-translate-y-2 transition-transform duration-500">
                  <p className="text-2xl md:text-3xl font-black text-white mb-1">04+</p>
            ...
            >
              <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tighter uppercase">I Am Pathum Sanjaya</h2>
              ...
              <div className="space-y-2 md:space-y-3 pt-2">
                <div className="flex items-center gap-3 text-white hover:text-brand-green transition-colors font-bold uppercase tracking-widest text-xs cursor-default">
              ...
              <div className="pt-4 md:pt-6">
                <Link
                  to="/design"
                  className="group inline-flex items-center gap-3 bg-white text-black px-6 py-3 rounded-full font-black text-xs md:text-sm hover:bg-brand-green transition-all w-full sm:w-auto justify-center"
                >
                  EXPLORE MY WORK
      ...
      <section className="py-10 md:py-16 bg-[#050505]">
        <div className="container-custom px-4 md:px-0">
          <div className="flex flex-col items-center text-center mb-10 md:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-3xl font-black text-white tracking-tighter uppercase">SKILLS & EXPERTISE</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            {skills.map((skill, index) => (
              <motion.div
                ...
                whileHover={{ y: -5, backgroundColor: "rgba(57,229,53,0.05)", borderColor: "rgba(57,229,53,0.2)" }}
                className="p-4 rounded-xl glass-morphism border-white/5 text-center flex flex-col items-center justify-center gap-2"
              >
                <div className="w-8 h-8 rounded-full bg-brand-green/10 flex items-center justify-center text-brand-green">
                  <Sparkles size={14} />
                </div>
                <span className="text-white font-bold text-[10px] uppercase tracking-widest">{skill}</span>
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="container-custom px-4 md:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <div className="relative rounded-[3rem] overflow-hidden border border-white/10 group">
                ...
                <div className="absolute bottom-12 left-12 max-w-sm">
                  <p className="text-white font-black italic text-xl md:text-2xl leading-tight uppercase tracking-tighter">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl font-black text-white tracking-tighter uppercase leading-[0.85]">
              ...
              <div className="pt-4">
                <div className="inline-flex flex-col gap-2">
                  <span className="text-[10px] font-bold text-white/20 uppercase tracking-[0.3em]">Design Credo:</span>
                  <div className="h-[2px] w-12 bg-brand-green" />
                  <p className="text-white font-black text-sm uppercase tracking-widest">LEGENDARY. BOLD. AUTHENTIC.</p>
                </div>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container-custom px-4 md:px-0">
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-1 pr-4">
              ...
              <h2 className="text-2xl md:text-3xl font-black text-white tracking-tight leading-none mb-6">THE <br /> CREATIVE <br /> FLOW</h2>
            </div>
            ...
            <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4">
              {processSteps.map((step, idx) => (
                <motion.div
                  key={idx}
                  whileHover={{ y: -5 }}
                  className="p-8 rounded-[2rem] glass-morphism border-white/5 relative overflow-hidden group"
                >
                  ...
                  <div className="relative z-10">
                    <h3 className="text-lg font-black text-white mb-3 uppercase tracking-widest">{step.title}</h3>
                    <p className="text-white/40 leading-relaxed font-medium text-sm">{step.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container-custom text-center">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-3xl md:text-4xl font-black text-white tracking-tighter">LEAVE A <span className="text-brand-gradient">MARK</span></h2>
            <p className="text-white/40 text-sm md:text-base max-w-2xl mx-auto font-medium">Ready to start a project that stands the test of time? Let's talk.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
              ...
              <Link to="/contact" className="text-white hover:text-brand-green font-black text-sm md:text-base flex items-center gap-3 transition-colors group">
